...
describe('Starting tests for digitalproperty-app', function() {
  ...
  it('website title should be digitalproperty-app', () => {
    page.navigateTo('/');
    return browser.getTitle().then((result)=>{
      expect(result).toBe('digitalproperty-app');
    })
  });

  it('navbar-brand should be digitalproperty-network@0.1.8',() => {
    var navbarBrand = element(by.css('.navbar-brand')).getWebElement();
    expect(navbarBrand.getText()).toBe('digitalproperty-network@0.1.8');
  });
